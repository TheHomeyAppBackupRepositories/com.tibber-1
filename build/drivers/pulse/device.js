...
class PulseDevice extends homey_1.Device {
    ...
    async onInit() {
        ...
        __classPrivateFieldSet(this, _PulseDevice_resubscribeDebounce, (0, ts_debounce_1.debounce)(__classPrivateFieldGet(this, _PulseDevice_instances, "m", _PulseDevice_subscribeToLive).bind(this), __classPrivateFieldGet(this, _PulseDevice_resubscribeMaxWaitMilliseconds, "f")), "f");
    ...
    async subscribeCallback(result) {
        ...
        __classPrivateFieldGet(this, _PulseDevice_resubscribeDebounce, "f").call(this).then(() => { });
