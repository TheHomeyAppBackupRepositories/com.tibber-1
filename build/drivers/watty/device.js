...
class WattyDevice extends homey_1.Device {
    ...
    async onInit() {
        ...
        __classPrivateFieldSet(this, _WattyDevice_resubscribeDebounce, (0, ts_debounce_1.debounce)(__classPrivateFieldGet(this, _WattyDevice_instances, "m", _WattyDevice_subscribeToLive).bind(this), __classPrivateFieldGet(this, _WattyDevice_resubscribeMaxWaitMilliseconds, "f")), "f");
    ...
    async subscribeCallback(result) {
        ...
        __classPrivateFieldGet(this, _WattyDevice_resubscribeDebounce, "f").call(this).then(() => { });
    ...
    destroy() {
        if (typeof __classPrivateFieldGet(this, _WattyDevice_wsSubscription, "f").unsubscribe === 'function') {
            try {
